...
\begin{figure}[H]
    ...
    \caption{A simple example of a QCA unitary. The yellow boxes represent qubits, while the red and blue rectangles represent the two-qubit local unitaries that implement the dynamics over one timestep.}
