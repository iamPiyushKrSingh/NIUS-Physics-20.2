...
\date{
    \today \\[6ex]
    \includegraphics[width = 0.7\textwidth]{quantum-xkcd.png}
}
...
\begin{list}{}{}
    ...
    \item[\bfseries Global Function:] For a given lattice \(L\) (with a defined neighbourhood scheme), the local transition function \(f\) imposes a global transition function \(F\) on the set of all possible configurations. This global function determines the \emph{space/time} behavior of the cellular automaton on an initial configuration.
\end{list}
