...
\begin{figure}[H]
    ...
    \label{fig:toy-ext}
\end{figure}
Using the same methodology, we can compute the final state of the Julia program (see \cref{lst:toy-ext})
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{fidelity_plot.png}
    \caption{Hello}
    \label{fig:fidelity}
\end{figure} \noindent
...
\lstinputlisting[language=julia, caption={Simulating the final state of our extended system using matrix operations}, label={lst:toy-ext}]{./codes/toy-model.jl}
